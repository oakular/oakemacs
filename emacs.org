...
#+BEGIN_SRC emacs-lisp
  (defun oak/setup-fonts () "Setup basic font configuration."
         (let ((monospace-font "Cascadia Code-9"))
           (set-face-attribute 'default nil :font monospace-font)
           (set-face-attribute 'fixed-pitch nil :font monospace-font))
           (when WINDOWS (set-face-attribute 'variable-pitch nil :font "Arial-10")
                 (set-face-attribute 'variable-pitch nil :font "Overpass-8")))
...
#+BEGIN_SRC emacs-lisp
  (use-package magit
    ...
    :init
    (oak/define-global-keymap '("C-x vd" . magit-status))
    (oak/define-global-keymap '("C-x vb" . magit-blame))
    (oak/define-global-keymap '("C-x v+" . magit-pull))
    (oak/define-global-keymap '("C-x vp" . magit-push))
