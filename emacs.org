...
** COMMENT Blog
#+begin_src emacs-lisp
  (add-to-list 'org-publish-project-alist (list "site-org"
                                                 :base-directory "."
                                                 :base-extension "org"
                                                 :recursive t
  ...
  (add-to-list 'org-publish-project-alist (list "site-static"
                                                 :base-directory "."
                                                 :exclude "public/"
  ...
  (add-to-list 'org-publish-project-alist (list "site" :components '("site-org" "site-static")))
#+end_src
* Accounting
